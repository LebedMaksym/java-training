...
public class FirstNameStudentComparator implements Comparator<Student> {
  ...
  public FirstNameStudentComparator() {
  }

  public FirstNameStudentComparator(int direction) {
  ...
  public int compare(Student student, Student studentNext) {
    ...
    String item = student != null ? student.getFirstName() : "";
    String itemNext = studentNext != null ? studentNext.getFirstName() : "";
